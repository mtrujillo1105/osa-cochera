...
.butt {
	...
	height: 100%;
	float: right;
	 background-image: url('<?php echo base_url(); ?>public/images/icons/salid.png?=<?=IMG;?>');
...
.button {
 background-image: url('<?php echo base_url(); ?>public/images/icons/documents.png?=<?=IMG;?>');
...
.button2:hover {
 background-image: url('<?php echo base_url(); ?>public/images/icons/documentfail.png?=<?=IMG;?>');
