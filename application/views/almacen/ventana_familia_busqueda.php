...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>public/js/almacen/ventana_familia.js?=<?=JS;?>"></script>
    </head>
                ...
                <div id="frmBusqueda" style="width:95%"  align='left'>
                    ...
                    <form id="<?php echo $formulario; ?>" method="post" action="<?php echo base_url(); ?>index.php/almacen/familia/ventana_busqueda_familia/<?php echo $flagBS; ?>">
                        ...
                        <div id="botonBusqueda" style="width:85%">
                            <a href="#" id="seleccionarFamilia"><img src="<?php echo base_url(); ?>public/images/icons/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" border="1" ></a>						
                            <a href="#" id="cancelarFamilia"><img src="<?php echo base_url(); ?>public/images/icons/botoncancelar.jpg?=<?=IMG;?>" width="85" height="22" border="1" ></a>
                        </div>
                    </form>
                </div>
            </div>
