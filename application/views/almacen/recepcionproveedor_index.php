                    ...
                    if(count($lista)>0){
                        foreach($lista as $indice=>$valor)
                        {
                            ...
                            <tr class="<?php echo $class;?>">
                                ...
                                <td><div align="center"><a href="#" onclick="ver_recepcionproveedor(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>public/images/icons/ver.png?=<?=IMG;?>" width="16" height="16" border="0" title="Ver"></a></div></td>
                                <td><div align="center"><a href="#" onclick="editar_recepcionproveedor(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>public/images/icons/modificar.png?=<?=IMG;?>" width="16" height="16" border="0" title="Modificar"></a></div></td>
                                <td><div align="center"><a href="#" onclick="eliminar_recepcionproveedor(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>public/images/icons/eliminar.png?=<?=IMG;?>" width="16" height="16" border="0" title="Eliminar"></a></div></td>
                            </tr>
                            <?php
                        }
                    }
