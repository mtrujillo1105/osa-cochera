<script type="text/javascript" src="<?=$base_url;?>public/js/almacen/guiarem.js?=<?=JS;?>"></script>
...
<div id="frmBusqueda" >
    <form id="form_busqueda" name="form_busqueda" method="post" action="<?=$base_url;?>index.php/almacen/guiarem/listar">
