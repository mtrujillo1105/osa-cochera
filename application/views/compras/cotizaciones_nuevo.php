		...
		<table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
		  ...
		  <tr>
                    ...
                    <td valign="middle">
                        ...
                        <a href="javascript:;" id="agregarProv" name="agregarProv"><image src="<?=$base_url;?>public/images/icons/add.png?=<?=IMG;?>" name="agregarFila" id="agregarFila" border="0" alt="Agregar"></a>
