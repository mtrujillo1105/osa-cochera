		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					...
					<a href="#" onclick="atras_proveedor();"><img src="<?=$base_url;?>public/images/icons/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" border="1" onMouseOver="style.cursor=cursor"></a>
			  </div>
		  </div>
		  </div>
		</div>
