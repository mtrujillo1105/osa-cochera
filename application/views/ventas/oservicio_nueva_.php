            ...
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td width="10%" valign="middle">
                        <?php if ($tipo_oper == 'V') { ?>
                            <!--label for="P"><img src="<?php //echo base_url() ?>public/images/icons/presupuesto.png?=<?=IMG;?>"
                                                style="cursor:pointer;" class="imgBoton"/></label>
                            <input type="hidden" name="presupuesto" id="presupuesto"-->

                        <?php } else { ?>
                            <!--label for="P"><img src="<?php //echo base_url() ?>public/images/icons/cotizacion.png?=<?=IMG;?>"
                    ...
                    <td width="5%">
                        <?php if ($tipo_oper == 'V') { ?>
                            <!--label for="O"><img src="<?php //echo base_url() ?>public/images/icons/docrecurrente.png?=<?=IMG;?>"
                                                style="cursor:pointer;"
                                                class="imgBoton"/></label-->
                        <?php } else { ?>
                            <!--label for="O"><img src="<?php //echo base_url() ?>public/images/icons/docrecurrente.png?=<?=IMG;?>"
