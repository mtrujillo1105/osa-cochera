...
<html>
	<head>	
        <script type="text/javascript" src="<?=$base_url;?>public/js/ventas/presupuesto.js?=<?=JS;?>"></script>
	...
	<br>
		<div id="pagina">
			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="<?=$base_url;?>index.php/ventas/presupuesto/presupuestos">
                                    <div id="frmBusqueda" >
					<table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
						...
						<tr>
                                                    ...
                                                    <td align='left'>
                                                        ...
                                                        <a href="<?=$base_url;?>index.php/empresa/cliente/ventana_busqueda_cliente/" id="linkVerCliente" tabindex="-1" ><img height='16' tabindex="-1" width='16' src='<?php echo base_url(); ?>/images/ver.png?=<?=IMG;?>' title='Buscar' border='0' /></a>
                                                    </td>
						</tr>
						<tr>
										...
										<input name="nombre_producto" type="text" value="<?php echo $nombre_producto; ?>" class="cajaGrande cajaSoloLectura" id="nombre_producto" size="40"  />
										                <a href="<?=$base_url;?>index.php/almacen/producto/ventana_busqueda_producto/" id="linkVerProducto" tabindex="-1" ><img height='16' tabindex="-1" width='16' src='<?php echo base_url(); ?>/images/ver.png?=<?=IMG;?>' title='Buscar' border='0' /></a>
                                                    </td>
						</tr>
					</table>
			  </div>
