   ...
   <?php echo $form_open;?>
    <div id="tituloForm" class="header" style="width:95%; padding-top: 0px;">
        <ul class="lista_tipodoc">
			<li style="background-color: #FF3333;"><a href="<?=$base_url;?>index.php/ventas/presupuesto/ventana_muestra_presupuestoRecu/<?php echo $tipo_oper; ?>/<?php if($tipo_oper=='V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/<?php echo $almacen; ?>/P">PRESUPUESTO(RECURRENTE) </a></li>
			<li ><a href="<?=$base_url;?>index.php/ventas/presupuesto/ventana_muestra_Opedido/<?php echo $tipo_oper; ?>/<?php if($tipo_oper=='V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/<?php echo $almacen; ?>/OP">ORDEN DE PEDIDO</a></li>
