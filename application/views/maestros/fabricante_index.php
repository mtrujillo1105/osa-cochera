				...
				<form id="form_busqueda" method="post">
					<div class="row">
						<div class="col-lg-4 form-group">
							...
							<input type="text" name="search_descripcion" id="search_descripcion" value="" placeholder="Fabricante" class="form-control"/>
						</div>
						<div class="col-lg-8 form-group align-self-end">
							...
							<button type="button" class="btn btn-success" id="nuevo" data-toggle='modal' data-target='#add_fabricante'>Nuevo</button>
						</div>
					</div>
				</form>
			</div>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card card-light">
			...
			<div class="card-body">
				<table class="table table-striped table-bordered" id="table-fabricante">
					<thead>
						<tr>
							<td style="width:20%" data-orderable="false">CÓDIGO</td>
							<td style="width:70%" data-orderable="false">FABRICANTE</td>
...
<div id="add_fabricante" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="formFabricante" method="POST">
				<div class="modal-header">
					<h4 class="modal-title">REGISTRAR FABRICANTE</h4>
				</div>
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-lg-3 form-group">
							...
							<input type="text" id="codigo_fabricante" name="codigo_fabricante" class="form-control" placeholder="Código" value="">
						</div>
						<div class="col-lg-9 form-group">
							<label for="descripcion_fabricante">DESCRIPCIÓN DE FABRICANTE *</label>
							<input type="text" id="descripcion_fabricante" name="descripcion_fabricante" class="form-control" placeholder="Indique el fabricante" value="">
						</div>
					</div>
				</div>
