<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <!--<div class="total" style="overflow: auto; padding: 2%;">-->
      	...
      	<div class="contenido" style="width: 90%; margin: auto; height: 450px; overflow: auto;">
            <div class="tempde_head">

                <!-- BUSQUEDA DE ARTICULOS PERSONALIZADA -->
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 tempde_stock">
                        Tipo de Servicio
                    </div>
                    <div class="col-sm-3 col-md-3 col-lg-3 tempde_stock d-none">
                        Marca
                    </div>
                    <div class="col-sm-3 col-md-3 col-lg-3 tempde_stock d-none">
                        Modelo
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 tempde_stock">
                        <input type="text" id="tempde_filtro_familia" name="tempde_filtro_familia" list="Familias" autocomplete="off" placeholder="Tipo servicio">
                ...
                <div class="cajaCabecera">
                    ...
                    <select name="flagBS" id="flagBS" class="form-control d-none" style="display: inline-block; width: 60px;" onchange="limpiar_campos_modal();">
                    ...
                    <span style="display: none; height: 45px; width: 20px; cursor: pointer;" id="linkVerVentasArticulo" name="linkVerVentasArticulo" class="d-none">
                        <img src="<?=base_url();?>public/images/icons/icono-factura.gif?=<?=IMG;?>"/>
                    </span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1 col-md-1 col-lg-1"><label for="tempde_Total">Total</label></div>
                ...
                <div class="row collapse">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>><label for="tempde_icbper">ICBPER</label></div>
                </div>
                <div class="row collapse">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3 tempde_stock" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>>
            ...
            <div class="tempde_body" style="margin-left: 5%;">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-1 col-lg-4"></div>
                    <div class="col-sm-3 col-md-1 col-lg-3"></div>
                    <div class="col-sm-5 col-md-10 col-lg-5">
...
<script type="text/javascript">
	...
	function agregar_producto_temporal(){
            if ( cantArtIngresados() >= <?php echo VENTAS_FACTURA;?> ){
...
//
//
	    //fila += '<td width="5%"><div style="text-align:center;"><a href="#" data-toggle="modal" data-target=".bd-example-modal-lg"  onclick="editar_producto_temporal(' + n + ');"><img src="'+base_url+'public/images/edit.png?=<?=IMG;?>" width="20" height="20"  border="0" tittle="editar"></a>';
	    //fila += '<td width="5%"><div style="text-align:center;"><a href="#" onclick="eliminar_producto_temporal(' + n + ');"><img src="'+base_url+'public/images/delete.png?=<?=IMG;?>" width="20" height="20"  border="0" tittle="eliminar"></a>';
	...
	function agregar_productotemp_modificado(fila){
        ...
        function agregar_items(){
            ...
            //Solo permite ingresar 1 registro al detalle
            n = document.getElementById('tempde_tblbody').rows.length;
            if(n<1){
                ...
                Swal.fire({
                    icon: "info",
                    title: "Solo puede ingresar 1 registro al detalle.",
                    html: "<b class='color-red'></b>",
			...
			success:function(data){
				if (data == "1"){ 
					...
					limpiar_campos_modal();
                                        ...
                                        //Ocultamos el modal de productos
	...
	function array_temporal_producto(datos,detaccion,randomColor = '', serie = null, num_comprobante = null, tipo = null){
		...
		$.each(datos, function (i, item) {
            ...
            //aca BOTON EDITAR AL MOMENTO DE EDITAR COMPROBANTE
		    //fila += '<td width="5%"><div style="text-align:center;"><a href="#" data-toggle="modal" data-target=".bd-example-modal-lg"  onclick="editar_producto_temporal(' + n + ');"><img src="'+base_url+'public/images/edit.png?=<?=IMG;?>" width="20" height="20"  border="0" tittle="editar"></a>';
                    
           //Botón eliminar AL MOMENTO DE EDITAR COMPROBANTE
    //fila += '<td width="5%"><div style="text-align:center;"><a href="#" onclick="eliminar_producto_temporal(' + n + ');"><img src="'+base_url+'public/images/delete.png?=<?=IMG;?>" width="20" height="20"  border="0" tittle="eliminar"></a>';
			...
			success:function(data){
				if (data.message == '1') {
					...
					limpiar_campos_prod_temporal();
                                        ...
                                        //Array de productos donde esta el control editar
	...
	function calcular_temProducto_modal(){
		...
		//$("#tempde_subTotal").val(igvLinea.toFixed(5));
		//$("#tempde_igvLinea").val(subTotal.toFixed(5));
